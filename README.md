...
Concepts and techniques used in this project were learned from:

- **XGBoost** — StatQuest with Josh Starmer, 4-part series: [Part 1: Regression](https://www.youtube.com/watch?v=OtD8wVaFm6E), [Part 2: Classification](https://www.youtube.com/watch?v=8b1JEDvenQU), [Part 3: Mathematical Details](https://www.youtube.com/watch?v=ZVFeW798-2I), [Part 4: Crazy Cool Optimizations](https://www.youtube.com/watch?v=oRrKeUCEbq8)
- **SHAP** — [SHAP playlist](https://www.youtube.com/playlist?list=PLqDyyww9y-1SJgMw92x90qPYpHgahDLIK), theory and coding tutorials for the Python SHAP package
- **General ML foundations** — *Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow: Concepts, Tools, and Techniques to Build Intelligent Systems*, 3rd Edition, Aurélien Géron (O'Reilly)
